...
% TODO: write something for each dataset + image augmentation
\section{Datensätze}
...
Das Kernstück eines U-Nets ist der sogenannte ConvBlock. Ein ConvBlock beinhaltet zwei hintereinander geschaltete Blöcke, die wiederrum % TODO: kp was in der Korrektur steht
