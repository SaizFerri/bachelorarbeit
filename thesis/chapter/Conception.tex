...
\\
\\
Abschließend wird ein komplexeres und hochauflösendes Datensatz verwendet. Das Thema von dem Datensatz ist Natur. Ziel damit ist, ein Netzwerk zu
trainieren das Bilder aus Natur einfärben kann. Dieser besteht aus Komplette und Teile von Datensätze aus 
Kaggle\footnote{\url{https://www.kaggle.com/}} und GitHub\footnote{\url{https://github.com/}}. Das Datensatz besteht aus 8 Klassen und hat insgesamt
13363 Bilder, 10945 für das Training und 2409 für das Testen. Alle Bilder werden auf $ 128 \times 128 $ angepasst um die Trainingszeit möglichst
gering zu halten.

\section{Data Preprocessing und Argumentation}
% TODO: Preprocessing und argumentation erklären
