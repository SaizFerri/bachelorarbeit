...
Das Ziel von einem Feedforward Neural Network ist die Annäherung an irgendeine Funktion $ f^* $. Feedforward Neural Network definiert 
...
Feedforward Neural Network werden als eine Kette von Funktionen repräsentiert. Als Beispiel,
